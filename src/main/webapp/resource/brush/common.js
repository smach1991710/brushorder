...
function showdiv(keyaa){
    $("#cover").css('display','block');
    $("#message").css('display','block');
   $("#message textarea").val(keyaa);
}
$(document).ready(function() {
    ...
    if (!sessionStorage.getItem('menu')) {
        $('#menu #tongzhili').addClass('active');
    } else {
...
$(document).ready(function(){
    $("#passwordok").click(function(){
        ...
        // var url="goto.php?op=RankTask.Action&ac=savenote";
        //
        // url=url+"?q="+str;
    ...
    $("#message .fa").click(function(){
        $("#cover").css('display','none');
        $("#message").css('display','none');
    });

    // $(".iconcolor i a:first-child").click(function(){
    //
    //     $("#cover").css('display','block');
    //     $("#message").css('display','block');
    // });
    $(".iconcolor i a:first-child").click(function(event){
