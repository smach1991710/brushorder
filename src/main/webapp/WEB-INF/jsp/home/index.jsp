...
<html>
<head>
    <title>亚马逊订单管理系统 </title>
    <link rel="stylesheet" href="<%=path%>/resource/js/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="<%=path%>/resource/css/font-awesome.min.css">
    <link rel="stylesheet" href="<%=path%>/resource/css/index.css">
    <link rel="stylesheet" href="<%=path%>/resource/css/skins/_all-skins.css">
</head>
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            <a href="#" target="_blank" class="logo">
                <span class="logo-mini">亚马逊</span>
                <span class="logo-lg"><font size='4'>亚马逊订单管理系统</font></span>
            </a>
                    		...
                    		<tr>
                    			<td>
                    				<a href="#" class="dropdown-toggle" data-toggle="dropdown">
                               			<img alt="请点击这里给我发消息哦!" src="<%=path%>/resource/img/qqzx.jpg">
                            		</a>
                    			</td>
                    			<td>
                    				<img src="<%=path%>/resource/img/welcome_user.png">
                        			<span>欢迎您：<font color='red' size='3'>${loginUser.user.name}</font></span>
                    			</td>
                    			<td>
                    				<img src="<%=path%>/resource/img/balance.png">
                        			<span>账户余额：<font color='red' size='3'>${loginUser.user.accoutmoney}</font></span>
                    			</td>
                    			<td>
        ...
        <div id="content-wrapper" class="content-wrapper">
            <div class="content-tabs" style="background-color: #D9D9D9">
            ...
            <div class="content-iframe" style="overflow: hidden;">
                <div class="mainContent" id="content-main" style="margin: 10px; margin-bottom: 0px; padding: 0;">
                    <iframe class="LRADMS_iframe" width="100%" height="100%" src="<%=path%>/home/toWelcome" frameborder="0" data-id="default.html"></iframe>
                </div>
            </div>
        </div>
    </div>
    <script src="<%=path%>/resource/js/jquery/jQuery-2.2.0.min.js"></script>
    <script src="<%=path%>/resource/js/bootstrap/js/bootstrap.min.js"></script>
</body>
...
(function ($) {
    ...
    $.learunindex = {
        ...
        loadMenu: function () {
            var data = [
						{ "F_ModuleId": "1", "F_ParentId": "0", "F_FullName": "系统管理", "F_Icon": "fa fa-desktop", "F_UrlAddress": null, "F_Target": "expand", "F_IsMenu": 0, "F_AllowExpand": 1, "F_IsPublic": 0, "F_AllowEdit": null, "F_AllowDelete": null, "F_SortCode": 1, "F_DeleteMark": 0, "F_EnabledMark": 1},
						{ "F_ModuleId": "11", "F_ParentId": "1", "F_FullName": "账号列表", "F_Icon": "fa fa-database", "F_UrlAddress": "<%=path%>/account/accountmanager", "F_Target": "iframe", "F_IsMenu": 1, "F_AllowExpand": 1, "F_IsPublic": 0, "F_AllowEdit": null, "F_AllowDelete": null, "F_SortCode": 1, "F_DeleteMark": 0, "F_EnabledMark": 1, "F_Description": "行政区域管理", "F_CreateDate": "2015-11-12 14:38:20", "F_CreateUserId": "System"}, 
						{ "F_ModuleId": "12", "F_ParentId": "1", "F_FullName": "用户列表", "F_Icon": "fa fa-user", "F_UrlAddress": "<%=path%>/user/usermanager", "F_Target": "iframe", "F_IsMenu": 1, "F_AllowExpand": 1, "F_IsPublic": 0, "F_AllowEdit": null, "F_AllowDelete": null, "F_SortCode": 1, "F_DeleteMark": 0, "F_EnabledMark": 1, "F_Description": "动态链接数据库", "F_CreateDate": "2015-11-24 09:50:22", "F_CreateUserId": "System", "F_CreateUserName": "超级管理员", "F_ModifyDate": "2016-04-29 14:07:45", "F_ModifyUserId": "System", "F_ModifyUserName": "超级管理员" }, 
                   	];
            var _html = "";
